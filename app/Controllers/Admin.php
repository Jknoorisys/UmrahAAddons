...
class Admin extends ResourceController
{
	...
	public function getUserDetail()
	{
		...
		$bookings = $db->table('meals_booking as b')
              ->select('b.*, p.title as meal_name, CONCAT(u.firstname," ",u.lastname) as user_name, CONCAT(pro.firstname," ",pro.lastname) as provider_name, CONCAT(o.firstname," ",o.lastname) as ota_name')
