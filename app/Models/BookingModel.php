...
class BookingModel extends Model
{
	...
	public function getbookingdetailforuser(array $trnx_filters, $per_page, $page_no, $add_filter, $abc, $service_type, $logged_user_id)
	{
		...
		$query = "SELECT l.*,CONCAT (p.firstname,' ',p.lastname) as provider_name,
							...
							JOIN tbl_pax_master AS pax ON pax.id = l.no_of_pox  
							JOIN tbl_vehicle_master AS vec ON vec.id = l.cars  
							JOIN tbl_package AS pa ON pa.id = l.service_id  WHERE l.service_type = 'package' AND  l.provider_id = $logged_user_id";
